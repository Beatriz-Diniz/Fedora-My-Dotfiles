...
Item {
    ...
    Timer {
        ...
        onTriggered: {
            ...
            greetingLabel.text = "<b> </b> " + greeting + ", " + userModel.data(userModel.index(userListId.currentIndex, 0), Qt.UserRole + 2)
        }
    }
    ...
    Item {
        ...
        BlurredCard {
            ...
            Image {
                source: "file:///var/lib/AccountsService/icons/beatrizdiniz"
